...
p{
    ...
    <body>
        ...
        <p>Добродошли на наш вебсајт! Молимо вас да пажљиво прочитате следеће услове коришћења пре него што наставите са коришћењем функционалности и садржаја овог вебсајта. Коришћењем ове платформе, изјављујете да сте упознати и сагласни са свим наведеним условима и да се обавезујете да ћете поштовати законе Републике Србије.</p>
...
<p>Коришћењем овог вебсајта, прихватате све одредбе ових услова коришћења и обавезујете се на поштовање закона Републике Србије. Уколико се не слажете са било којом ставком, молимо вас да прекинете употребу наше платформе.</p>

<p>Хвала вам што користите нашу услугу!</p>
    </div>
    </body>
